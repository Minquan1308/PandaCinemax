    ...
    public partial class New : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeatOrders_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "SeatOrderDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SeatOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatOrderDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeatOrderDetails_SeatOrders_SeatOrderId",
                        column: x => x.SeatOrderId,
                        principalTable: "SeatOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatOrderDetails_SeatOrderId",
                table: "SeatOrderDetails",
                column: "SeatOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_SeatOrders_UserId",
                table: "SeatOrders",
                column: "UserId");
